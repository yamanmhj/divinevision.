          ...
          <div className="flex mt-10 flex-col mb-10 justify-center items-center">
              ...
              <div className="px-2 ">
                <div className="ml-5 mt-14 ">
                  ...
                  >
                    ...
                    NDIS provider, our experienced and compassionate
                    professionals are here to support participants and their
                    families.
                  </h1>
            ...
            >
              <h1
                ...
                style={{ color: "#0C1246" }}
              >
                Empowering Lives Through Personalized NDIS Support.
              </h1>
              <h1
              ...
              >
                <span
                  ...
                  style={{ color: "#0C1246" }}
                >
                  Discover the difference that compassionate, local support can
                  make in your life.
                </span>{" "}
                <br />
                At Divine Vision, we offer compassionate, local services across
                Australia designed to empower individuals and enhance their
                lives.
              </h1>
              <div className="px-1 items-center mt-10">
                <button
                  className="bg-[#0C1246] flex items-center text-white py-1 px-6 rounded-full text-xl  transition-all duration-300 hover:scale-105"
            ...
            <div className="flex flex-wrap justify-center mt-10  shadow-6xl  ">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="w-full pb-10 sm:w-1/1 lg:w-1/3 p-4  "
                >
                  <div
                    className="flex flex-col  transition duration-250 items-center text-center rounded-xl  boorder hover:scale-105 mx-8 pt-10"
